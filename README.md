...
The tree-like structure is generated by placing ingredients in a vertical layout group adjacent to their 'parent' item which is also in a vertical layout group. Once all of the ingredients have been placed, lines are drawn from ingredients to their 'parent' item to visualize the recipe. <br/>
